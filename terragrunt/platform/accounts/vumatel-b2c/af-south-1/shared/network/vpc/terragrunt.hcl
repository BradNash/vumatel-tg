...
inputs = {
  vpc_cidr_block              = "10.186.0.0/18"
  public_subnets_cidr_block   = "10.186.0.0/22"
  private_subnets_cidr_block  = "10.186.16.0/20"
  isolated_subnets_cidr_block = "10.186.32.0/21"

  # Allow public subnet to connect to isolated subnet for NLB forwarding, TODO: Remove once VPN setup is done
  semi_isolated_routed_subnets = ["10.186.0.0/22"]
}
