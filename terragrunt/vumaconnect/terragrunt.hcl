locals {
  ...
  context = {
    ...
    tags = {
      management-team = "VumaConnect Team"
      business-unit   = "vuma-connect"
      environment    = local.environment_vars.locals.environment
      created-by      = "Terraform"
      cost-center     = "vumaconnect"
    }
  }
